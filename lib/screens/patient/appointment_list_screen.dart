...
class _AppointmentListScreenState extends ConsumerState<AppointmentListScreen>
      ...
      body: FadeTransition(
        ...
        child: Stack(
          children: [
            ...
            // Custom Back Button positioned at top left
            if (widget.onBackPressed != null || Navigator.canPop(context))
              Positioned(
  ...
  Widget _buildAppointmentList(List<Appointment> appointments) {
    ...
    if (_showCurrent) {
      filtered = appointments.where((a) {
        final isFuture = a.dateTime.isAfter(
      ...
      filtered = appointments.where((a) {
        final isPast = a.dateTime.isBefore(
          now.subtract(const Duration(days: 1)),
        );
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                _showCurrent
                    ? 'Book one with your doctor today!'
    ...
    return RefreshIndicator(
      ...
      child: ListView.builder(
        ...
        itemBuilder: (context, index) =>
            _buildAppointmentCard(filtered[index], index),
      ),
    );
  }
          ...
          children: [
            ...
            Row(
              ...
              children: [
                // Date icon + text
                Expanded(
                  child: _infoColumn(Icons.calendar_today, 'Date', dateStr),
                ),
                Expanded(
                  child: _infoColumn(
                ...
                Expanded(
                  child: _infoColumn(personIcon, personLabel, personName),
                ),
              ],
            ),
            Padding(
      ...
      case 'pending':
        ...
        return Column(
          children: [
            ...
            const SizedBox(height: 8),
            if (isDoctor) ...[
              // Accept Button for doctors
              GestureDetector(
                onTap: () {
                  if (appointmentId != null) {
                    _showAcceptDialog(appointmentId);
                  }
                },
                child: Container(
                  padding: const EdgeInsets.symmetric(
            ...
            // Cancel Button (shown for both doctors and patients)
            GestureDetector(
              onTap: () {
                if (appointmentId != null && userId != null) {
                  _showCancelDialog(appointmentId, userId);
  ...
  void _showAcceptDialog(String appointmentId) {
    showDialog(
      context: context,
      builder: (ctx) => AlertDialog(
        shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(22)),
        ...
        content: Column(
          ...
          children: [
            ...
            const SizedBox(height: 10),
            Text(
              'Are you sure you want to accept this appointment? It will be marked as confirmed.',
              textAlign: TextAlign.center,
              style: TextStyle(
                color: Colors.grey.shade600,
                fontSize: 14,
